...
public class Main {
    ...
    /**
     * Main method used to test the program There is a need for one and only one argument passed
    ...
    public static void main(String[] args) {
        ...
        // Running the said optimization problem. The parsing, initializing and running will all be
