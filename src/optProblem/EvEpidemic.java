...
/**
 * @author antonio
 * This subclass is an extension of the abstract Event class and will handle the Epidemic events.
 * It has a static field of its own and inherits time and individual from the superclass. Individual is set to null and time is the actual time so it happens in the next iteration of the simulation.
 * The static field is an Individual Comparator.
...
public class EvEpidemic extends Event{
	...
	//ATTRIBUTES
	static IndividualComparator ic = new IndividualComparator();
	 ...
	 * @param op is the Optimization Problem in question. This way we can get the actual time instant.
	 */
