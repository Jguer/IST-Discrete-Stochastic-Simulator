...
/**
 * @author antonio
 * This class is for Special Zones of the map, i.e.,the two points that delimit a rectangular area and the cost associated to moving in the said zone.
 */
public class SpecialZone {
	...
	//CONTRUCTORS
	/**
	 * This method is the constructor for the SpecialZone. All it does is associate the points and cost with the variables of the SpecialZone object.
