 ...
 * Has a field for the associated individual and one for the time in which we should execute the event.
 * There are 2 static fields. The first is a Random object to generate random numbers and the other is an Event Comparator that is used when we want to add events to the PEC.
 * Execute Event and toString methods must be overridden.
 */
public abstract class  Event implements IEvent{
	...
	//CONTRUCTORS
	/**
	 * Constructor of the Event class. Since Event is abstract this constructor will have to be called from the subclasses using this()
	...
	/**
	 * Method that returns a random number according to an exponential pdf with mean m. 
	 * This method doesn't depend on who invokes it so it is static and it will be invoked from the class itself.
