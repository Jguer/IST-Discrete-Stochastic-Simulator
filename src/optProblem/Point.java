...
/**
 * @author antonio
 * This class will store a Point, i.e., a pair of (x,y) values.
 * No attributes are static so each object will have their own.
...
public class Point {
	...
	//CONTRUCTORS
	/**
	 * Constructor for the Point Class. It should only receive 2 integers and will associate each to the corresponding point in the class.
	...
	/**
	 * Method to clone an Array List of Points.
	 * The clone relies on the Constructor and is done in a for loop iterating over the points in the list.
	 * This way we get 2 lists in memory, each with their own objects. If we change one of them it will not change the other.
